...
<body>
  <table class="collapse">
    <tr id="header">
      <td class="alignmiddle txtcenter" style="width: 150px; background-color: #2F5376;"><a href="<{xoAppUrl }>" title=""><img src="<{xoAppUrl images/logo.gif}>" alt="" /></a></td>
  ...
  <table class="width80 txtcenter bnone" cellspacing="1" cellpadding="10">
    <tr>
      <td class="txtcenter"><div class="txtcenter bold" style="background-color: #DDFFDF; color: #136C99; border-top: 1px solid #DDDDFF; border-left: 1px solid #DDDDFF; border-right: 1px solid #aaa; border-bottom: 1px solid #aaa; padding: 10px;"><{$lang_siteclosemsg}></div></td>
    </tr>
  </table>
  ...
  <form action="<{xoAppUrl user.php}>" method="post">
    <table class="collapse txtcenter solidsilver" style="width: 200px;">
      ...
      <tr>
        <td class="pad2"><{$lang_username}></td><td class="pad2"><input type="text" name="uname" size="12" value="" /></td>
      </tr>
      <tr>
        <td class="pad2"><{$lang_password}></td><td class="pad2"><input type="password" name="pass" size="12" /></td>
      </tr>
      <tr>
        <td class="pad2">&nbsp;</td>
        <td class="pad2">
