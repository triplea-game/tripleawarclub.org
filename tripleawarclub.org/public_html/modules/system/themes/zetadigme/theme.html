...
<{includeq file="$theme_tpl/xo_parameters.html"}>
</head>
...
<div id="xo-wrapper" class="<{$xoops_dirname}>">
	...
	<!-- zone HEADER -->
		...
		<{if $theme_view_header}><{includeq file="$theme_tpl/xo_banner.html"}><{/if}>
		...
		<div  id="xo-canvas-content">
			<{if $modules}>
				...
				<table id="xo-index">
					...
					<tr>
						<td id="xo-modules" class="CPindexOptions"><{if $theme_view_accordion}><{includeq file="$theme_tpl/xo_accordion.html"}><{/if}></td>
					</tr>
					<{if $theme_view_blocksys}><{includeq file="$theme_tpl/xo_block.html"}><{/if}>
				</table>
			<{/if}>
	...
	<!-- zone FOOTER -->
	<{if $theme_view_footersys}><{includeq file="$theme_tpl/xo_footer.html"}><{/if}>
</div>
	<{if $theme_view_baradmin}><{includeq file="$theme_tpl/xo_footerstatic.html"}><{/if}>
</body>
</html>