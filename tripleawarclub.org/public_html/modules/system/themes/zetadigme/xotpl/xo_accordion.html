	...
	<dl>
			...
			<dd id="Section2">
					<table>
						...
						<tr>
							<td>License</td>
							<td>
								<a rel="external" href="http://www.gnu.org/licenses/gpl.html" title="<{$smarty.const.XOOPS_LICENSE_CODE}>">
						...
						<tr>
							<td></td>
							<td>
								<a rel="external" href="http://www.gnu.org/licenses/gpl-2.0.html" title="<{$smarty.const.XOOPS_LICENSE_TEXT}>">
		...
		<dd id="Section4">
			<table>
				<tr>
					<td>
						<a class="tooltip" rel="external" href="http://sourceforge.net/projects/xoops" title="<{$lang_xoops_xoopsproject}>"><{$lang_xoops_xoopsproject}></a>
					</td>
					<td>
