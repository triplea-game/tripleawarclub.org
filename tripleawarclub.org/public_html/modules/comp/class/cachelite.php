...
* @subpackage Comp
* @author Clausewitz
* @changes to the version: altered class name, altered constructor name to setOptions, new constructor added
*/
...
class CompCacheliteHandler
{
    ...
    */
	...
	// new constructor
	function CompCacheliteHandler() {
		$this->_cacheDir = XOOPS_ROOT_PATH . "/modules/comp/cache/";
		$this->_lifeTime = 3600;	// 1 hour
		$this->_automaticSerialization = true;
	}
