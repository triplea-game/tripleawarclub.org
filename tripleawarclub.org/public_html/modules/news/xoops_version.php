...
$modversion['tables'][0] = 'mod_news_stories';
$modversion['tables'][1] = 'mod_news_topics';
$modversion['tables'][2] = 'mod_news_stories_files';
$modversion['tables'][3] = 'mod_news_stories_votedata';
...
if (is_object($xoopsModule) && $xoopsModule->getVar('dirname') == $modversion['dirname'] && $xoopsModule->getVar('isactive')) {
    ...
    if (!isset($_SESSION['items_count']) || $_SESSION['items_count']== -1) {
        $sql = "SELECT COUNT(*) as cpt FROM ".$xoopsDB->prefix("mod_news_topics")." WHERE menu=1";
