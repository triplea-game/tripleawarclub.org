<?php
// $Id: news_top.php 10043 2012-08-08 22:36:24Z beckmi $
//  ------------------------------------------------------------------------ //
	...
	if($options[8]==2) {		// Tabbed view ********************************************************************************************
	    ...
	    if (!isset($spotlight) && $options[4]) {
            ...
            if($block['use_spotlight']==true) {
        		$spotlight = array();
        		$spotlight['title'] = $spotlightArticle->title();//xoops_substr($spotlightArticle->title(),0,($options[2]-1));;
        		if ($options[7] != '') {
