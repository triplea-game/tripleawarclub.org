...
DHTMLSuite.config.prototype = {
	...
	init : function()
	{
		this.imagePath = '{xoops_root}/modules/multimenu/templates/include/multimenu_suite_horizontal/';	// Path to images
		this.cssPath = '{xoops_root}/modules/multimenu/templates/include/multimenu_suite_horizontal/';	// Path to images
	}
	// }}}
	,
	// {{{ setCssPath()
...
DHTMLSuite.menuItem = function()
{
	...
	this.layoutCSS = 'multimenu_suite_horizontal_{id}.css';
