...
DHTMLSuite.config.prototype = {
	...
	init : function()
	{
		this.imagePath = '/var/www/triplea/xoops/modules/multimenu/templates/include/multimenu_suite_horizontal/';	// Path to images
		this.cssPath = '/var/www/triplea/xoops/modules/multimenu/templates/include/multimenu_suite_horizontal/';	// Path to images
	}
	// }}}
	,
	// {{{ setCssPath()
...
DHTMLSuite.menuItem = function()
{
	...
	this.layoutCSS = 'multimenu_suite_horizontal_1.css';
