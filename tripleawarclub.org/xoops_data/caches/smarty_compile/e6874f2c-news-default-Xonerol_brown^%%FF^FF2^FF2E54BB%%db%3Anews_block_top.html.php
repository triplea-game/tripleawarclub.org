...
<?php endif; ?>
	...
	<?php if ($this->_tpl_vars['block']['current_is_spotlight'] && $this->_tpl_vars['block']['tabs']['id'] == 0): ?>
		<table border='0' class="current-tab">
		<tr>
			<td colspan='2'>
				<table border='0'>
...
/modules/news/index.php?storytopic=1">News &raquo;</a></h2>

<div id="newsContent">

<table class="classical-view">
	<?php if ($this->_tpl_vars['block']['spotlight']): ?>
	<tr>
		<td><table class="block-spotlight itemHeader">
		<tr>
			<td class="itemTitle">
				<!--<table border='0'>
				<tr><td><img src='<?php echo $this->_tpl_vars['block']['spotlight']['topic_image']; ?>
...
"><?php echo $this->_tpl_vars['block']['spotlight']['title']; ?>
</a>
		...
		<td class="itemInfo"><span class="itemPoster"><?php echo $this->_tpl_vars['block']['spotlight']['author']; ?>
</span></td>
		</td>
		</tr>
		<tr>
...
<td colspan='2' class="itemBody"><?php echo $this->_tpl_vars['block']['spotlight']['text']; ?>
</td>
		</tr>
		<!--<tr>
			<td colspan='2'>
...
"><?php echo $this->_tpl_vars['block']['lang_read_more']; ?>
	...
	<?php endif; ?>
	<tr>
		<td class="block-stories itemOtherArticles">
			<h3>Recent News</h3>
			<div class="news-list">
			<ul>
					...
					<?php if ($this->_tpl_vars['news']['id'] != $this->_tpl_vars['block']['spotlight']['id']): ?>
						...
						<h2>
						   <span>
							...
							<?php elseif ($this->_tpl_vars['block']['sort'] == 'published'): ?>
								<span class="date"><?php echo $this->_tpl_vars['news']['date']; ?>
</span> - 
							<?php else: ?>
