<?php /* Smarty version 2.6.28, created on 2016-02-13 19:39:56
         compiled from /usr/share/nginx/html/tripleawarclub.org/public_html/modules/system/language/english/help/preferences.html */ ?>
...
<p class="even">
Meta tags provide information about your information – they describe the nature of your website. Their main use is to help search engines and their robots to index your website correctly, i.e. to help the right people find it. The information you supply is included in the header of each web page. It should represent the content of the site as a whole - the meta information is the same on every page, it currently cannot be customised for different modules or pages.<br /><br />
