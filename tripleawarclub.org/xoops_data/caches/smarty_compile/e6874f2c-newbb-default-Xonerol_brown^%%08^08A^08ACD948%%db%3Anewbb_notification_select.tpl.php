<?php /* Smarty version 2.6.28, created on 2016-03-10 16:14:06
         compiled from db:newbb_notification_select.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'db:newbb_notification_select.tpl', 23, false),)), $this); ?>
<?php if ($this->_tpl_vars['xoops_notification']['show']): ?>
    <form name="notification_select" action="<?php echo $this->_tpl_vars['xoops_url']; ?>
/modules/<?php echo $this->_tpl_vars['xoops_dirname']; ?>
/<?php echo $this->_tpl_vars['xoops_notification']['target_page']; ?>
" method="post">
