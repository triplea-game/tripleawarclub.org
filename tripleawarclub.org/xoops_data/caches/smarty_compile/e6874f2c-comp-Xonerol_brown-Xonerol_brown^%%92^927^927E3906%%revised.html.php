<?php /* Smarty version 2.6.28, created on 2016-02-13 21:40:44
         compiled from /usr/share/nginx/html/tripleawarclub.org/public_html/modules/comp/rules/revised.html */ ?>
<style>
...
play.</p>
<p>The winner of each game is the first to reach 9
...
<p>Axis &amp; Allies 4ed Standard Rules and/or Low Luck rules. (These
options are selected in the <b>My Profile</b> link in the flyout menu for each ladder.)</p>
<p>The current stable version, as of the above date, of TripleA is <b>v1.0.0.3</b>.</p>
<p>The Axis bid is set to 9 IPCs. These IPCs may be spent on units to be placed on the board prior to game start. The IPC may be
...
player desires.</p>
<p>The Territory Turn Limit Option is in effect so this box under
the <b>Options</b> tab must be checked prior to starting a
game.</p>
...
<p>Both players need to agree if tech is available to be rolled or not, <i>before starting the match</i>. Tech is either available for the
...
<ul class="rules" id="lists">
<li>You MUST ask the defender for an OOL prior to rolling any dice
if it is a situation that calls for an OOL, and</li>
<li>You MUST go through the attack once an OOL has been given. The
...
<h5>PBEM Games</h5>
<p>Editing in PBEM games is not as forgiving as live games. In PBEM games, players have the opporunity to practice their moves as many times as they would like. And it also gives players the opportunity to save between movement phases for futher testing. With that said, editing in PBEM games are limited to; fixing game bugs (such as correct carrier movement) and fixing <strong>entirely</strong> missed placements.</p>
...
<p>To report a game, click on the <b>Report Game</b> link in the 
fly-out menu for the competition. The reporting
players name will be shown in the table's left column. To the right
of this are drop down boxex for the allies game and the axis game. 
...
problem.</p>
<p>In addition, there is an option to rate a player in the competition fly-out menu. 
...
<li>K value for ratings < 2000 is 150</li>
<li>K value for ratings between 2000 and 2400 is 100</li>
<li>K value for ratings > 2400 is 50</li>
...
<p>A player's Rank is a function of rating points, the breakdown is:</p>
<ul class="rules" id="lists">
<li>General 2001+</li>
<li>Colonel 1751 - 2000</li>
<li>Major 1501 - 1750</li>
<li>Captain 1251 - 1500</li>
<li>Lieutenant 1001 - 1250</li>
<li>Sergeant 751 - 1000</li>
<li>Corporal 501 - 750</li>
<li>Private 1 - 500</li>
</ul>
<p>The #1 player is rewarded with a special rank of Field Marshal.</p>
...
<p>A player may leave a competition by clicking on the Leave Competition button on the fly-out menu. Their account is removed from the board and no more challenges
