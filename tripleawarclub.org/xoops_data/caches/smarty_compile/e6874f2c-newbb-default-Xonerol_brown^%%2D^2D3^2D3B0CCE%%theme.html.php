<?php /* Smarty version 2.6.28, created on 2016-03-10 16:14:06
         compiled from /usr/share/nginx/html/tripleawarclub.org/public_html/themes/default/theme.html */ ?>
...
echo 'http://www.tripleawarclub.org/themes/default/icons/favicon.ico'; ?>" />
    <link rel="icon" type="image/png" href="<?php 
echo 'http://www.tripleawarclub.org/themes/default/icons/favicon.png'; ?>" />

    <!-- Sheet Css -->
    <link rel="stylesheet" type="text/css" media="all" title="Style sheet" href="<?php echo 'http://www.tripleawarclub.org/xoops.css'; ?>" />
    <link rel="stylesheet" type="text/css" media="all" title="Style sheet" href="<?php 
echo 'http://www.tripleawarclub.org/themes/default/style.css'; ?>" />
	<!--[if lte IE 8]>
		<link rel="stylesheet" href="<?php 
echo 'http://www.tripleawarclub.org/themes/default/styleIE8.css'; ?>" type="text/css" />
	<![endif]-->
...
<table cellspacing="0">
    <tr id="header">
        <td id="headerlogo"><a href="<?php echo 'http://www.tripleawarclub.org/'; ?>" title="<?php echo $this->_tpl_vars['xoops_sitename']; ?>
"><img src="<?php 
echo 'http://www.tripleawarclub.org/themes/default/xoops-logo.png'; ?>" alt="<?php echo $this->_tpl_vars['xoops_sitename']; ?>
" /></a></td>
