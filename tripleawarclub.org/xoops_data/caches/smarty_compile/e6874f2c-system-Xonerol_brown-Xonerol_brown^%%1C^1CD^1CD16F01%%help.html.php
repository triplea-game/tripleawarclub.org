<?php /* Smarty version 2.6.28, created on 2016-02-28 19:32:41
         compiled from /usr/share/nginx/html/tripleawarclub.org/public_html/modules/protector/language/english/help/help.html */ ?>
<div id="help-template" class="outer">
    <h1 class="head">Help: <a class="ui-corner-all tooltip" href="<?php echo $this->_tpl_vars['xoops_url']; ?>
/modules/protector/admin/index.php" title="Back to the administration of Protector"> Protector <img src="<?php 
echo 'http://www.tripleawarclub.org/modules/system/images/icons/default/home.png'; ?>" alt="Back to the administration of Protector"/></a></h1>
    <!-- -----Help Content ---------- -->
